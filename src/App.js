...
const App = () => {
  ...
  return (
    <NoteState>
      ...
      <Route exact path = "/TeacherDashboard/TeacherDashboard" Component={TeacherDashboard}/>
      <Route exact path = "/StudentDashboard/StudentDashboard" Component={StudentDashboard}/>
